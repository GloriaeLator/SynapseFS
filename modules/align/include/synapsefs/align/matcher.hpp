...
/// + Jacobi auction, docs/adr/0011): used once a group's size reaches
...
struct SparseMatchOptions {
    ...
    /// widen-retry. 512 is still cheap: at n=57943 (ADR 0011's measured
...
struct MatchOptions {
    ...
    /// slow, it doesn't fit in memory (docs/adr/0011).
